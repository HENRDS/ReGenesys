...
void Match::_execute(Entity* entity) {
    ...
    this->_model->getTraceManager()->traceSimulation(Util::TraceLevel::simulation, this->_model->getSimulation()->getSimulatedTime(), 
        entity, this, "Connection from getCurrentInputNumber: " + std::to_string(n)); 
